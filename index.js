...
function gerarFaturaStr(fatura, pecas) {
  ...
  for (let apre of fatura.apresentacoes) {
    faturaStr += `  ${calc.repo.getPeca(apre).nome}: ${formatarMoeda(calc.calcularTotalApresentacao(pecas, apre))} (${apre.audiencia} assentos)\n`;
  }
...
function gerarFaturaHTML(fatura, pecas) {
  ...
  faturaHTML += "<ul>\n";
  for (let apre of fatura.apresentacoes) {
    faturaHTML += `<li>  ${this.repo.getPeca(apre).nome}: ${formatarMoeda(calcularTotalApresentacao(pecas, apre))} (${apre.audiencia} assentos) </li>\n`;
  }
  faturaHTML += "</ul>\n";
